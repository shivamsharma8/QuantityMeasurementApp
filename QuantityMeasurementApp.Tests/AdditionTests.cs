...
namespace QuantityMeasurementApp.Tests
{
    public class AdditionTests
    {
        ...
        {
            var q1 = new Quantity<LengthUnit>(2.54, LengthUnit.Centimeter);
        ...
        //     var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
        //     var q2 = new Quantity<LengthUnit>(12.0, LengthUnit.Inch);
        //     var result1 = Quantity<LengthUnit>.Add(q1, q2);
        //     var result2 = Quantity<LengthUnit>.Add(q2, q1);
        //     Assert.AreEqual(result1.Value, Quantity<LengthUnit>.Convert(result2.Value, result2.Unit, result1.Unit), 1e-6);
        // }
        ...
        {
            var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
            Assert.Throws<System.ArgumentException>(() => Quantity<LengthUnit>.Add(q1, null));
        }

        [Test]
        public void Addition_LargeValues()
        {
            var q1 = new Quantity<LengthUnit>(1e6, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(1e6, LengthUnit.Feet);
            var result = Quantity<LengthUnit>.Add(q1, q2);
        ...
        public void Addition_SmallValues()
        {
            ...
            var q2 = new Quantity<LengthUnit>(0.002, LengthUnit.Feet);
            var result = Quantity<LengthUnit>.Add(q1, q2);
