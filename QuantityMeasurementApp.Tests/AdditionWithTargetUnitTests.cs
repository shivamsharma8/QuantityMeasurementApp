...
namespace QuantityMeasurementApp.Tests
{
    public class AdditionWithTargetUnitTests
    {
        ...
        public void Addition_ExplicitTargetUnit_Inches()
        {
            var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(12.0, LengthUnit.Inch);
            var result = Quantity<LengthUnit>.Add(q1, q2, LengthUnit.Inch);
        ...
        public void Addition_ExplicitTargetUnit_Yards()
        {
            var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(12.0, LengthUnit.Inch);
            var result = Quantity<LengthUnit>.Add(q1, q2, LengthUnit.Yard);
        ...
        public void Addition_ExplicitTargetUnit_Centimeters()
        {
            ...
            var result = Quantity<LengthUnit>.Add(q1, q2, LengthUnit.Centimeter);
        ...
        public void Addition_ExplicitTargetUnit_Commutativity()
        {
            var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(12.0, LengthUnit.Inch);
            var result1 = Quantity<LengthUnit>.Add(q1, q2, LengthUnit.Yard);
            var result2 = Quantity<LengthUnit>.Add(q2, q1, LengthUnit.Yard);
        ...
        public void Addition_ExplicitTargetUnit_NullTargetUnit_Throws()
        {
            var q1 = new Quantity<LengthUnit>(1.0, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(12.0, LengthUnit.Inch);
            Assert.Throws<System.ArgumentException>(() => Quantity<LengthUnit>.Add(q1, q2, (LengthUnit)999));
        }

        [Test]
        public void Addition_ExplicitTargetUnit_LargeToSmallScale()
        {
            var q1 = new Quantity<LengthUnit>(1000.0, LengthUnit.Feet);
            var q2 = new Quantity<LengthUnit>(500.0, LengthUnit.Feet);
            var result = Quantity<LengthUnit>.Add(q1, q2, LengthUnit.Inch);
